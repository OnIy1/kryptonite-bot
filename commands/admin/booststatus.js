// commands/admin/booststatus.js - Updated to use Supabase
...
module.exports = {
  ...
  async execute(client, message, args) {
    try {
      ...
      // Log to Supabase
      await client.db.logAction('boost_status_check', message.author.id, { 
        remaining_time: remainingTime,
        multiplier: client.boostSystem.multiplier
      });
    } catch (error) {
